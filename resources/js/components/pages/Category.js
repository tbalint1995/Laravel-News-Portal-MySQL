...
export default function Category(props) {
        ...
        const [url, setUrl] = React.useState('/api/category/' + Store.getState().id );


        Store.subscribe(()=>{
                setUrl('/api/category/' + Store.getState().id)
        })
...
//        ReactDOM.render(<Category />, document.getElementById('category_list'))